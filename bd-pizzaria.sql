...
CREATE TABLE PIZZARIA.TELEFONE_CLIENTE (
  ...
  CONSTRAINT FK_TELEFONE_CLIENTE_2_CLIENTE FOREIGN KEY (COD_CLIENTE) REFERENCES CLIENTE (COD_CLIENTE)
);
...
CREATE TABLE PIZZARIA.TAMANHO_PIZZA (
  ...
  CONSTRAINT FK_TAMANHO_PIZZA_2_PIZZA FOREIGN KEY (COD_PIZZA) REFERENCES PIZZA (COD_PIZZA)
);
...
CREATE TABLE PIZZARIA.PEDIDO (
  ...
  CONSTRAINT FK_PEDIDO_2_CLIENTE FOREIGN KEY (COD_CLIENTE) REFERENCES CLIENTE (COD_CLIENTE)
);
...
CREATE TABLE PIZZARIA.CONTEM (
  ...
  CONSTRAINT FK_CONTEM_2_PEDIDO FOREIGN KEY (NUM_PEDIDO) REFERENCES PEDIDO (NUM_PEDIDO),
  CONSTRAINT FK_CONTEM_2_TAMANHO_PIZZA FOREIGN KEY (COD_PIZZA, DESC_TAMANHO_PIZZA) REFERENCES TAMANHO_PIZZA (COD_PIZZA, DESC_TAMANHO_PIZZA)
);
